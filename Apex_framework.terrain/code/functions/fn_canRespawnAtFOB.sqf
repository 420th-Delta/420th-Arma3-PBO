...
_nearSideObjective = (([FALSE] call QS_fnc_sideMissionPositions) findIf {(_downedPosition distance _x) < 2500}) isNotEqualTo -1;
(
	((_deploymentDistance < _baseDistance) || (_aoDistance < 2500) || _nearSideObjective) &&
