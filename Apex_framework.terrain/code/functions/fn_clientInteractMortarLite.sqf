...
// Updated Code
// Use the same server-owned three-mortar section as Support requests. The
// existing tube action and carry controls remain; admission comes before the
// backpack is consumed, so a full section cannot waste a tube or spawn a fourth.
['REQUEST_TUBE'] call QS_fnc_mortarSupport;
// End Updated Code
