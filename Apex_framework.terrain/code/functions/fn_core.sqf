...
for '_x' from 0 to 1 step 0 do {
	...
	_QS_diagTickTimeNow = diag_tickTime;
// Added Code
	// Mortar support shares this three-second core pass in every mission type.
...
// Added Code
	// KAVALA_REVIVE_WATCH_BEGIN
	// Reuse the core pass to restore role rules after a stopped/failed mission,
	// including manual starts. Script handles stay server-local; only the flag is public.
...
// Updated Code
					// Altis' native custom mission is Kavala. Its role-death override
					// permits high-population play; other maps retain their upper gate.
