...
// A bounded entry search avoids holding the AI loop when players cover the map.
_randomPos = [];
...
// Keep creation in one unscheduled block so a teardown cannot leave a partial patrol.
isNil {
