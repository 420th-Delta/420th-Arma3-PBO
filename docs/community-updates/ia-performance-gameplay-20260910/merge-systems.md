...
The three-way artifact had an encoding defect in the radio mapping comment (`1â€“10` versus the payload's `1–10`); the resolved comment uses ASCII hyphens. Other clean-merged files need the same encoding audit before committing.
